...
namespace METODOS_ARRAY
{
    class Program
    {
        static void Main()
        {
            ...
            long qtdeElementosVetor = vetor3.GetLongLength(0);
            ...
            Console.WriteLine("Valor da psição 3 do vetor1: {0}", valor0);
            Console.WriteLine("___________________________");

            //public static int IndexOf(array,valor);
            Console.WriteLine("IndexOf");
            int indice1 = Array.IndexOf(vetor1, 3);
            Console.WriteLine("Indice doprimeiro valor 3:{0}", indice1);
            Console.WriteLine("___________________________");
